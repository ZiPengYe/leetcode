...
## <a id="70">#70</a> Climbing Stairs(爬楼梯)
...
**Note(注意):** Given *n* will be a positive integer.
...
Input(输入): 2
Output(输出): 2
Explanation(解释): There are two ways to climb to the top.
1. 1 step + 1 step
2. 2 steps
```
**Example(示例) 2:**
...
Input(输入): 3
Output(输出): 3
Explanation(解释): There are three ways to climb to the top.
